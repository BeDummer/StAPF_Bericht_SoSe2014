...
\addsec{Aktuelle Zusammensetzung}
	...
	\end{itemize}
\textbf{St\"andiges beratendes Mitglied:} J\"org Behrmann
\pagebreak
...
\addsec{MeTaFa/Kontakt zu BuFaTas}
	\begin{itemize}[label=\mycbox{mydotcolor}]
		...
		\begin{itemize}[label=\color{mydotcolor2}$\pmb\rightarrow$]
			\item Themen: \quad \emph{???}
		\end{itemize}
		\item n"achstes Treffen im ??? \emph{(in Planung)}
		\item Besuche verschiedener BuFaTas: \quad \emph{???}
	\end{itemize}
